        ...
        <section class="section order">
          <div class="container">
            ...
            <div class="order__form">
              <form class="order__form-tag" id="order-form" action="./php/order.php" method="post">
                ...
                <div class="order__form-col">
                  ...
                  <div class="order__form-buttons">
                    ...
                    <div class="order__form-row">
                      <input class="order__form-button" name="" type="submit" value="Заказать" id="order-form-submit">
